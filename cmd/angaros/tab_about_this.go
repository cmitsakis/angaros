...
func tabAboutThis() *container.TabItem {
	content := container.NewVBox(
		widget.NewLabel(fmt.Sprintf("Angaros version %s", appVersion)),
		widget.NewLabel("Copyright (C) 2021 Charalampos Mitsakis"),
		widget.NewLabel("Angaros is licensed under the terms of the PolyForm Internal Use License 1.0.0 https://polyformproject.org/licenses/internal-use/1.0.0"),
	...
	return container.NewTabItemWithIcon("Angaros", theme.InfoIcon(), container.NewScroll(content))
}
